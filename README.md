...
The 5.36–5.38 run below came out of a full multi-agent deep review of the whole
plugin and its companion scripts — a fresh sweep for correctness, robustness and
shared-user fit, with every finding verified before it was fixed and the test
suite grown to 246 to lock the fixes in.
